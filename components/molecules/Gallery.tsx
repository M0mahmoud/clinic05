            ...
            <div className="flex gap-4 w-full justify-center">
                <div className="flex flex-col  gap-4 relative">
                    <Image
                        ...
                        width={225}
                        height={225}
                        className="object-cover w-56 h-56 rounded-sm aspect-square"
                    />
                    <Image
                        loading="lazy"
                        src={images[1]}
                ...
                <div className="flex flex-col  gap-4 relative">
                    <Image
                        ...
                        width={183}
                        height={275}
                        className="object-cover w-56 h-full rounded-sm"
                    />
                </div>
                <div className="flex flex-col  gap-4 relative">
                    <Image
                        ...
                        width={225}
                        height={225}
                        className="object-cover w-56 h-56 rounded-sm"
                    />
                    <div className="flex gap-2">
                        <Image
                            ...
                            width={120}
                            height={225}
                            className="object-cover w-24 h-56 rounded-sm"
                        />
                        <Image
                            loading="lazy"
                            src={images[5]}
